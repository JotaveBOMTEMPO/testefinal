...
app.get('/', autenticar, (req, res) => {
    ...
    return res.end(`
        <!DOCTYPE html>
            ...
            <body>
                <h1>Menu</h1>
                <a href="/cadastro.html">Cadastro de Novo Usuario</a>
                <a href="/chat.html">Acesso ao bate papo</a>
            </body>
            <footer>
...
app.get('/cadastro.html', autenticar, (req, res) => {
    res.sendFile(path.join(process.cwd(), './PaginasHTML/cadastro.html'));
});

app.post('/cadastro.html', autenticar, processaCadastroUsuario);
